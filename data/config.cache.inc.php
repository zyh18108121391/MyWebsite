...
$cfg_cmspath = '';
$cfg_cookie_encode = '13Rxw2UNTl87Ea0yh2nGGTw4KuQyq';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '';
$cfg_webname = '小房子-郑银华的专属网站';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '郑银华、郑银华的专属网站、小房子、';
$cfg_description = '专属于郑银华的专属网站，名叫小房子，这里是郑银华的另一天地，有相片、有日记、有视频、有访客留言等等，你喜欢郑银华的话就来看看吧！';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
